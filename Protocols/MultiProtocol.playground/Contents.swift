...
class Media : Rentable {
    let title: String // protocol Rentable implementation
    var barcode: String // protocol Rentable implementation
    init(title: String, barcode: String) {
        self.title = title
        self.barcode = barcode
    }
    func rent(forWeeks weeks: Int) -> Bool { // protocol Rentable implementation
...
for item in items {
    print("Item \(item) is rentable. Barcode is \(item.barcode).")
